...
public class MenuSystem : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Cargar el �ltimo nivel jugado al iniciar
    ...
    public void Jugar()
    {
        ...
        // Opcional: Detener m�sica al ir a niveles (si quieres m�sica diferente en niveles)
    ...
    public void NuevoJuego()
    {
        ...
        // Opcional: Detener m�sica al ir a niveles
        // AudioManager.Instance.DetenerMusica();
